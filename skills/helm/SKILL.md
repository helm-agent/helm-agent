...
| `start`      | Top-level umbrella: bring up daemon + server (both detached). No subcommands. Idempotent — re-running is safe and short-circuits already-running processes. `--tls-cert` / `--tls-key` / `--hostname` are forwarded to **server only**. `--bind` depends on form: `--bind <host>:<port>` (explicit port) is **server-only** (daemon stays on its loopback default), but host-only `--bind <host>` (no port) binds **both** daemon + server (each on an OS-assigned port) so the daemon is reachable for cross-server pairing. To bind only the daemon to a specific port, use `helm daemon start --bind <host>:<port>`. `--foreground` is rejected with a hint; run `helm daemon start --foreground` / `helm server start --foreground` in separate shells if you need attached lifecycles.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | (no subcommands)                                                                                                                             |
