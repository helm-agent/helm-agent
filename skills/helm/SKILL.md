...
| `start`      | Top-level umbrella: bring up daemon + server (both detached). No subcommands. Idempotent — re-running is safe and short-circuits already-running processes. `--bind` / `--tls-cert` / `--tls-key` / `--hostname` are forwarded to **server only** (daemon stays on its loopback default). `--foreground` is rejected with a hint; run `helm daemon start --foreground` / `helm server start --foreground` in separate shells if you need attached lifecycles.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | (no subcommands)                                                                                                                             |
